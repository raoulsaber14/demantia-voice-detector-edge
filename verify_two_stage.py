...
Usage:
    python verify_two_stage.py --backbone <path/to/backbone/model.onnx> \
                               --head     <path/to/head.onnx>

    # Or use the project-default paths:
    python verify_two_stage.py
"""
...
MODELS_ROOT = HERE / "dementia-voice-detector" / "models" / "phaseD_frozen_ensemble_deploy"
