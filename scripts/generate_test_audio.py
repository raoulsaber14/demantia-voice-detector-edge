...
def main() -> int:
    ...
    print("  python -m scripts.record_and_screen --input test_audio/normal_speech.wav  --threads 4")
    print("  python -m scripts.record_and_screen --input test_audio/dementia_speech.wav --threads 4")
    print()
