# Dementia Voice Screening Research Subproject

This folder contains the research pipeline, evaluation code, and curated final reports used in the repository-level submission.

It should be read as a **subproject inside the main submission repo**, not as a separate standalone public repo with all raw data and model artifacts included.
...
- `app/demo_app.py`: historical local research demo
