...
Used frozen references: `docs/OFFICIAL_BASELINE_CONFIGURATION.md`, `docs/BASELINE_MODEL_CARD.md`, `reports/FINAL_BASELINE_SUMMARY.md`, `reports/final_fp_fn_error_analysis.md`, `reports/phaseC_frozen_embedding_benchmark.md`, Phase C summary tables, the trusted cleaned manifest, and the canonical governed-pruned feature table. Phase C established `facebook/hubert-base-ls960` + `logistic_regression_platt` with `mean_score` as the best stable frozen embedding reference.
